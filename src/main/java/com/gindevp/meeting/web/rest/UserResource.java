...
import com.gindevp.meeting.web.rest.errors.EmailAlreadyUsedException;
import com.gindevp.meeting.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link com.gindevp.meeting.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
...
public class UserResource {
    ...
    public ResponseEntity<AdminUserDTO> createUser(@Valid @RequestBody AdminUserDTO userDTO) throws URISyntaxException {
        ...
        if (userDTO.getId() != null) {
            ...
            // Không gửi mail tạo user (server cloud chặn mail); pass mặc định 1234
            return ResponseEntity.created(new URI("/api/admin/users/" + result.getLogin()))
