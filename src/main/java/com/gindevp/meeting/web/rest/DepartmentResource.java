...
import com.gindevp.meeting.service.DepartmentService;
...
/**
 * REST controller for managing {@link com.gindevp.meeting.domain.Department}.
 */
@RestController
...
public class DepartmentResource {
     ...
     * @param status optional filter by status (e.g. ACTIVE, DISABLED).
    ...
    public ResponseEntity<List<DepartmentDTO>> getAllDepartments(
        ...
        Page<DepartmentDTO> page = departmentService.findAll(pageable, status);
