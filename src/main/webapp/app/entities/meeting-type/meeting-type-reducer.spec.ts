...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEETINGTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MEETINGTYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MEETINGTYPE actions', async () => {
      const arg = { id: 19338 };
    ...
    it('dispatches UPDATE_MEETINGTYPE actions', async () => {
      const arg = { id: 19338 };
    ...
    it('dispatches PARTIAL_UPDATE_MEETINGTYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MEETINGTYPE actions', async () => {
      const arg = 42666;
