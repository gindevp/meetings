...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEETINGTASK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MEETINGTASK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MEETINGTASK actions', async () => {
      const arg = { id: 11117 };
    ...
    it('dispatches UPDATE_MEETINGTASK actions', async () => {
      const arg = { id: 11117 };
    ...
    it('dispatches PARTIAL_UPDATE_MEETINGTASK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MEETINGTASK actions', async () => {
      const arg = 42666;
