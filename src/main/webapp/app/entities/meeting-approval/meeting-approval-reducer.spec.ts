...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEETINGAPPROVAL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MEETINGAPPROVAL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MEETINGAPPROVAL actions', async () => {
      const arg = { id: 12708 };
    ...
    it('dispatches UPDATE_MEETINGAPPROVAL actions', async () => {
      const arg = { id: 12708 };
    ...
    it('dispatches PARTIAL_UPDATE_MEETINGAPPROVAL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MEETINGAPPROVAL actions', async () => {
      const arg = 42666;
