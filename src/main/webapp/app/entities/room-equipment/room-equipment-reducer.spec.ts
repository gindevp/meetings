...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ROOMEQUIPMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ROOMEQUIPMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ROOMEQUIPMENT actions', async () => {
      const arg = { id: 1796 };
    ...
    it('dispatches UPDATE_ROOMEQUIPMENT actions', async () => {
      const arg = { id: 1796 };
    ...
    it('dispatches PARTIAL_UPDATE_ROOMEQUIPMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ROOMEQUIPMENT actions', async () => {
      const arg = 42666;
