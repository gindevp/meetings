...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEETINGLEVEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MEETINGLEVEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MEETINGLEVEL actions', async () => {
      const arg = { id: 13713 };
    ...
    it('dispatches UPDATE_MEETINGLEVEL actions', async () => {
      const arg = { id: 13713 };
    ...
    it('dispatches PARTIAL_UPDATE_MEETINGLEVEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MEETINGLEVEL actions', async () => {
      const arg = 42666;
