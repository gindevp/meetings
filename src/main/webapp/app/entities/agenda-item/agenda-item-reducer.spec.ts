...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AGENDAITEM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AGENDAITEM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AGENDAITEM actions', async () => {
      const arg = { id: 19451 };
    ...
    it('dispatches UPDATE_AGENDAITEM actions', async () => {
      const arg = { id: 19451 };
    ...
    it('dispatches PARTIAL_UPDATE_AGENDAITEM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AGENDAITEM actions', async () => {
      const arg = 42666;
