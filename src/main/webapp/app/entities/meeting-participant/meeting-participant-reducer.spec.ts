...
import reducer, {
  ...
  reset,
  updateEntity,
} from './meeting-participant.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEETINGPARTICIPANT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MEETINGPARTICIPANT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MEETINGPARTICIPANT actions', async () => {
      const arg = { id: 30411 };
    ...
    it('dispatches UPDATE_MEETINGPARTICIPANT actions', async () => {
      const arg = { id: 30411 };
    ...
    it('dispatches PARTIAL_UPDATE_MEETINGPARTICIPANT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MEETINGPARTICIPANT actions', async () => {
      const arg = 42666;
