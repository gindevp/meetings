...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEETINGDOCUMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MEETINGDOCUMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MEETINGDOCUMENT actions', async () => {
      const arg = { id: 25321 };
    ...
    it('dispatches UPDATE_MEETINGDOCUMENT actions', async () => {
      const arg = { id: 25321 };
    ...
    it('dispatches PARTIAL_UPDATE_MEETINGDOCUMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MEETINGDOCUMENT actions', async () => {
      const arg = 42666;
